...
import { getLatestReportCreatedAt } from '@/lib/sanity/queries'
...
export default async function PortalLayout({ children }: { children: React.ReactNode }) {
  const latestReportCreatedAt = await getLatestReportCreatedAt().catch(() => null)

  return (
    <ToastProvider>
      <div className="min-h-screen bg-cabin-linen">
        <Sidebar latestReportCreatedAt={latestReportCreatedAt} />
